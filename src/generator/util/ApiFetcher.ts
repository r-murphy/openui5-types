...
async function getServerApiJson(config: Config, namespace: string, version: string): Promise<ui5.API>
{
...
async function getFileApiJson(config: Config, path: string): Promise<ui5.API>
{
